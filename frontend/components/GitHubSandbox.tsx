...
const GitHubSandbox: React.FC<GitHubSandboxProps> = ({ importResult, onClose }) => {
    ...
    const [agentPanelWidth, setAgentPanelWidth] = useState(380); // pixels
        ...
        <>
            <div className="flex flex-col h-[calc(100vh-36px)] bg-zinc-950">
                ...
                <div className="flex items-center justify-between px-3 py-1.5 bg-zinc-900/50 border-b border-zinc-800 flex-shrink-0">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button
                            ...
                            className={`flex items-center gap-1.5 px-3 py-1.5 text-xs rounded-lg transition-colors font-medium border ${
                                showAgentPanel 
                ...
                <div className="flex flex-1 overflow-hidden" ref={mainContentRef}>
                    ...
                    {showAgentPanel && (
                        <div 
                            className="flex flex-col bg-zinc-900 border-l border-zinc-800 flex-shrink-0 overflow-hidden"
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between px-3 py-2 border-b border-zinc-800 bg-zinc-900/80">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-sm font-medium text-zinc-200">Kabada Agent</span>
                                    {agentLoading && (
                                        <span className="h-1.5 w-1.5 rounded-full bg-purple-400 animate-pulse" />
                                    )}
                                </div>
                            ...
                            <div ref={agentChatRef} className="flex-1 overflow-y-auto px-3 py-3 space-y-3">
                                {agentMessages.length === 0 && (
                                    <div className="flex flex-col items-center justify-center h-full text-center px-4">
                                        ...
                                        <p className="text-base font-medium text-zinc-300 mb-2">Kabada Agent</p>
                                                        ...
                                                        <div key={fi} className="bg-zinc-900/80 border border-zinc-700/50 rounded-lg overflow-hidden">
                                                            <div className="flex items-center justify-between px-3 py-1.5 bg-zinc-800/50">
                                                                <div className="flex items-center gap-1.5 text-xs">
                                                                    ...
                                                                    <span className="font-mono text-zinc-300 truncate max-w-[120px]">{fc.path}</span>
                            ...
                            <div className="flex flex-col border-t border-zinc-800 bg-zinc-900/50">
                                ...
                                <div className="flex items-center gap-2 px-3 py-3">
                                    ...
                                    <input
                                        ...
                                        className="flex-1 bg-zinc-800 border border-zinc-700 rounded-lg px-3 py-2 text-sm text-white placeholder-zinc-500 outline-none focus:border-purple-500/50 focus:ring-1 focus:ring-purple-500/20 transition-colors"
